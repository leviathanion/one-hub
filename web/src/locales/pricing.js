export const pricingTranslations = {
  zh: {
    ...
    'modelpricePage.cache_creation_input_tokens': '缓存写入令牌（Claude）',
    'modelpricePage.cache_read_input_tokens': '缓存读取令牌（Claude）',
  ...
  en: {
    ...
    'modelpricePage.cache_creation_input_tokens': 'Cached Write Tokens (Claude)',
    'modelpricePage.cache_read_input_tokens': 'Cached Read Tokens (Claude)',
