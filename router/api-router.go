	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.POST("/dashboard/modules/query", controller.QueryUserDashboardModules)
		...
		optionRoute.Use(middleware.RootAuth())
		{
			...
			optionRoute.GET("/channel_affinity_cache", controller.GetChannelAffinityCache)
			optionRoute.GET("/execution_session_cache", controller.GetExecutionSessionCache)
		...
		channelTagRoute.Use(middleware.AdminAuth())
		{
			...
			channelTagRoute.POST("/:tag/channel", controller.AddChannelToTag)
